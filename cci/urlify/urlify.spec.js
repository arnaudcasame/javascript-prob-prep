...
describe('URLify', () => {
    xtest('Should return Mr%20John%20Smith for (Mr John Smith)', () => {
        expect(urlify('Mr John Smith', 13)).toEqual('Mr%20John%20Smith');
    });
    xtest('Should return Terminal%20will%20be%20reused%20by%20tasks for (Terminal will be reused by tasks)', () => {
