...
export default describe('Palindrome #LinkedList', function(){
    ...
    it('Should return false for (atctcoa)', () => {
        const word = 'atctcoa';
        const list = ListNode.fromArray(word);
        expect(palindrome(list)).to.be.false;
    });
});