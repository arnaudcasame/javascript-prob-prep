...
export default describe('#4.1: Route Between Nodes', function() {
    ...
    it('Should return false for: f <--> j', function() {
        const graph = {
            f: ['g', 'i'],
            g: ['h'],
            h: [],
    ...
    it('Should return true for: i <---> h', function() {
        const graph = {
            f: ['g', 'i'],
            g: ['h'],
            h: [],
    ...
    it('Should return false for: v <---> h', function() {
        const graph = {
            v: ['x', 'w'],
            w: [],
            x: [],
    ...
    it('Should return false for: v <---> z', function() {
        const graph = {
            v: ['x', 'w'],
            w: [],
            x: [],
